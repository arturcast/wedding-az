$(document).ready(function () {
    ...
    for (var i = 0; i < share_bar.length; i++) {
        var html = '<iframe allowtransparency="true" frameborder="0" scrolling="no"' +
            'src="https://platform.twitter.com/widgets/tweet_button.html?url=' + encodeURIComponent(window.location) + '&amp;text=' + encodeURIComponent(document.title) + '&amp;via=arturcas&amp;hashtags=artutoyzully&amp;count=horizontal"' +
...
function initMap() {
    ...
    var locations = [
        ['Iglesia Santa Teresita', 11.01153722270539, -74.83707564139428, 4],
        ['Daltone House', 11.012850370775432, -74.83665973464142, 4],
      ];
      var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 18,
        center: new google.maps.LatLng(11.0123028994984, -74.83693037352661),
